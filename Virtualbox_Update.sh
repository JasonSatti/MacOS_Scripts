...
echo "Downloading latest version of Virtualbox"
cd /Users/$LOGGED_IN_USER/Downloads; curl -O $VIRTUALBOX_DOWNLOAD
...
## Remove the DMG
cd /Users/$LOGGED_IN_USER/Downloads; sudo rm $VIRTUALBOX_DMG