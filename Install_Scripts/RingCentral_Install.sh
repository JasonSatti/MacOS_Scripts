...
RINGCENTRAL_DOWNLOAD=$(curl -s https://success.ringcentral.com/RCSupportPortalDownloads | grep "Download for MAC" | grep "RCMeetingsClientSetup" | awk '{print $3}' | cut -f2 -d'"')
